<div class="export-settings settings-container">
    ...
    <div class="button-group">
        ...
        <?php if (iawp_is_pro()): ?>
            <button id="iawp-export-campaigns" class="iawp-button ghost-purple"><?php esc_html_e('Export Campaigns', 'independent-analytics'); ?></button>
            <button id="iawp-export-clicks" class="iawp-button ghost-purple"><?php esc_html_e('Export Clicks', 'independent-analytics'); ?></button>
        <?php endif; ?>
    </div>
</div>