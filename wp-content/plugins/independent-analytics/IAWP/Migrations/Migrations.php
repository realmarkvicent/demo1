...
class Migrations
{
    ...
    public static function create_or_migrate() : void
    {
        if (self::should_migrate()) {
            ...
            $completed = self::run_step_migrations([new \IAWP\Migrations\Migration_22(), new \IAWP\Migrations\Migration_23(), new \IAWP\Migrations\Migration_24(), new \IAWP\Migrations\Migration_25(), new \IAWP\Migrations\Migration_26(), new \IAWP\Migrations\Migration_27(), new \IAWP\Migrations\Migration_28(), new \IAWP\Migrations\Migration_29(), new \IAWP\Migrations\Migration_30(), new \IAWP\Migrations\Migration_31(), new \IAWP\Migrations\Migration_32(), new \IAWP\Migrations\Migration_33(), new \IAWP\Migrations\Migration_34(), new \IAWP\Migrations\Migration_35(), new \IAWP\Migrations\Migration_36(), new \IAWP\Migrations\Migration_37(), new \IAWP\Migrations\Migration_38()]);
            if ($completed === \true) {
    ...
    public static function is_migrating() : bool
    {
        ...
        $is_current = \version_compare($db_version, '38', '=');
    ...
    {
        $db_version = \get_option('iawp_db_version', '0');
        return \version_compare($db_version, '38', '>');
    }
